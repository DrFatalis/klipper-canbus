...
RUN python -m venv venv \
 && venv/bin/pip install --index-url https://pypi.org/simple numpy pyserial setuptools python-can --default-timeout=300
...
RUN pip3 install --index-url https://pypi.org/simple python-can pyserial numpy matplotlib
