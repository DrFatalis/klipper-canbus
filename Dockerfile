...
RUN python -m venv venv \
 && venv/bin/pip install --index-url https://pypi.org/simple numpy pyserial setuptools python-can --default-timeout=300 --trusted-host pypi.org --trusted-host files.pythonhosted.org
...
RUN pip3 install  --trusted-host pypi.org --trusted-host files.pythonhosted.org --index-url https://pypi.org/simple python-can pyserial numpy matplotlib
